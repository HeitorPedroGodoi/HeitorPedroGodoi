...
💻 Tenho afinidade com **front-end**, mas curto explorar o back-end e integrar soluções completas.  
📚 Nos momentos livres, escrevo ficção e leio — atividades que alimentam minha criatividade e atenção aos detalhes.

 **TCC MENTOR**:  
Uma plataforma web que usa IA (Google Gemini) para auxiliar alunos na criação de TCCs, com backends em Node.js e Python, frontend em EJS e banco MySQL. Ao qual eu participei e fiz o FrontEnd, sendo avaliado com nota 9,5.  
🔗 [Repositório do projeto](https://github.com/GustavoRez/TCC_Mentor)
